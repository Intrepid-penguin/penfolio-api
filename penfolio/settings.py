"""
Django settings for penfolio project.
...
SECRET_KEY = 'django-insecure-%x800z%#uovie0nmr7y1mdw)dabadif=(9#m9*d8*-zdz(fm22'
...
CORS_ALLOWED_ORIGINS = [
    ...
    '*://*.onrender.com',
    'https://penfolio-api.onrender.com',
]
...
WSGI_APPLICATION = 'penfolio.wsgi.application'
